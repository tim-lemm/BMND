...
fig, ax = plt.subplots(2,1,figsize=(30, 20))
fp = f"output/optimization/rgo_results_df_opt_CAP_SF_BIMODEL_3.csv"
df = pd.read_csv(fp)
...
plot_optimization_results("CAP_SF_BIMODEL_3", edge_df, node_df, save = True, file_path = "output/optimization/images/", edge_df_results = True, results_df_opt = True)