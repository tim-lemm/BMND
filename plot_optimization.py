...
fig, ax = plt.subplots(2,1,figsize=(30, 20))
fp = f"output/optimization/rgo_results_df_opt_CAP_SF_BIMODEL.csv"
df = pd.read_csv(fp)
...
plot_optimization_results("CAP_SF_BIMODEL", edge_df, node_df, save = True, file_path = "output/optimization/images/", edge_df_results = True, results_df_opt = True)