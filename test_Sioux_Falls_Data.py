...
# green_gdf = gpd.GeoDataFrame(green_df_raw, geometry='geometry', crs="EPSG:4326")
#
# plot_network(edge_df, node_df, node_label=True, title="Sioux Falls Network (Green)", color_col_num="green_overlap_percentage", cmap="Greens", base_width=1, ax=ax)
# green_gdf.plot(ax=ax, color='green')
...
# fig, ax = plt.subplots(figsize=(5, 7.5))
# plot_network(edge_df, node_df, node_label=True, title="Sioux Falls Network (slope)", color_col_num="slope", cmap="bwr", base_width=1, ax=ax)
# ax.set_xlim(-96.8,-96.69)
# ax.set_ylim(43.477,43.617)
# plt.show()

fig, ax = plt.subplots(figsize=(5, 7.5))
plot_network(edge_df, node_df, node_label=True, title="Sioux Falls Network (number of car lanes)", ax=ax, color_col_num="init_nbr_car_lane", base_width=1, cmap="summer_r")
ax.set_xlim(-96.8,-96.69)
ax.set_ylim(43.477,43.617)
plt.show()

fig, ax = plt.subplots(figsize=(5, 7.5))
plot_network(edge_df, node_df, node_label=True, title="Sioux Falls Network (number of access point)", ax=ax, color_col_num="nbr_access_point", base_width=1, cmap="summer_r")
ax.set_xlim(-96.8,-96.69)
ax.set_ylim(43.477,43.617)
plt.show()

fig, ax = plt.subplots(figsize=(5, 7.5))
plot_network(edge_df, node_df, node_label=True, title="Sioux Falls Network (right_side_clearance)", ax=ax, color_col_num="right_side_clearance", base_width=1, cmap="summer_r")
ax.set_xlim(-96.8,-96.69)
ax.set_ylim(43.477,43.617)
plt.show()
