...
edge_df_results.to_csv(f"output/optimization/rgo_edge_df_results_CAP_SF_BIMODEL_2.csv")
results_df_opt.to_csv(f"output/optimization/rgo_results_df_opt_CAP_SF_BIMODEL_2.csv")
